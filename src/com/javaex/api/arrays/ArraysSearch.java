...
//		기본 타입 검색
		...
		Arrays.sort(nums);	//	binarySearch는 sort가 우선이다.
		System.out.println("소팅된 원본:" + Arrays.toString(nums));
...
//		참조 타입 검색
		...
		Arrays.sort(str);
		System.out.println("소팅된 원본:" + Arrays.toString(str));
...
//		정렬
		Arrays.sort(members);
		System.out.println("소팅된 원본:" + Arrays.toString(members));
